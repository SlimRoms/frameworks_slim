...
public class IncreasingRingVolumePreference extends SlimPreference implements
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        float startVolume = SlimSettings.System.getFloat(cr,
                SlimSettings.System.INCREASING_RING_START_VOLUME, 0.1f);
        int rampUpTime = SlimSettings.System.getInt(cr,
                SlimSettings.System.INCREASING_RING_RAMP_UP_TIME, 10);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
        ...
        if (fromTouch && seekBar == mStartVolumeSeekBar) {
            SlimSettings.System.putFloat(cr, SlimSettings.System.INCREASING_RING_START_VOLUME,
            ...
            if (fromTouch) {
                SlimSettings.System.putInt(cr,
                        SlimSettings.System.INCREASING_RING_RAMP_UP_TIME, seconds);
            }
        }
    }
