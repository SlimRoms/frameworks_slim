...
public class BatteryLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //if (getResources().getBoolean(org.slim.framework.internal.R.bool.config_multiColorBatteryLed)) {
    ...
    private void refreshDefault() {
        ...
        if (mLowColorPref != null) {
            int lowColor = SlimSettings.System.getInt(resolver, SlimSettings.System.BATTERY_LIGHT_LOW_COLOR,
                    res.getInteger(com.android.internal.R.integer.config_notificationsBatteryLowARGB));
            mLowColorPref.setAllValues(lowColor, 0, 0, false);
        }

        if (mMediumColorPref != null) {
            int mediumColor = SlimSettings.System.getInt(resolver, SlimSettings.System.BATTERY_LIGHT_MEDIUM_COLOR,
        ...
        if (mFullColorPref != null) {
            int fullColor = SlimSettings.System.getInt(resolver, SlimSettings.System.BATTERY_LIGHT_FULL_COLOR,
    ...
    protected void updateValues(String key, Integer color) {
        ...
        if (key.equals(LOW_COLOR_PREF)) {
            SlimSettings.System.putInt(resolver, SlimSettings.System.BATTERY_LIGHT_LOW_COLOR, color);
        } else if (key.equals(MEDIUM_COLOR_PREF)) {
            SlimSettings.System.putInt(resolver, SlimSettings.System.BATTERY_LIGHT_MEDIUM_COLOR, color);
        /*} else if (key.equals(MEDIUM_FAST_COLOR_PREF)) {
            SlimSettings.System.putInt(resolver, SlimSettings.System.BATTERY_LIGHT_MEDIUM_FAST_COLOR, color);*/
        } else if (key.equals(FULL_COLOR_PREF)) {
            SlimSettings.System.putInt(resolver, SlimSettings.System.BATTERY_LIGHT_FULL_COLOR, color);
        }
    }
