...
import com.slim.settings.utils.PackageListAdapter;
import com.slim.settings.utils.PackageListAdapter.PackageItem;
...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMultiColorNotificationLed = resources.getBoolean(
                org.slim.framework.internal.R.bool.config_multiColorNotificationLed);
        ...
        mEnabledPref = (SwitchPreference)
                findPreference(SlimSettings.System.NOTIFICATION_LIGHT_PULSE);
        mEnabledPref.setOnPreferenceChangeListener(this);
        mCustomEnabledPref = (SwitchPreference)
                findPreference(SlimSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE);
        mCustomEnabledPref.setOnPreferenceChangeListener(this);

        mDefaultPref = (ApplicationLightPreference) findPreference(DEFAULT_PREF);
        mDefaultPref.setMultiColorLed(mMultiColorNotificationLed);
        mDefaultPref.setOnPreferenceChangeListener(this);

        // Missed call and Voicemail preferences should only show on voice capable devices
    ...
    private void refreshDefault() {
        ...
        int color = SlimSettings.System.getInt(resolver,
                NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, mDefaultColor);
        int timeOn = SlimSettings.System.getInt(resolver,
                NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, mDefaultLedOn);
        int timeOff = SlimSettings.System.getInt(resolver,
        ...
        if (mCallPref != null) {
            int callColor = SlimSettings.System.getInt(resolver,
                    NOTIFICATION_LIGHT_PULSE_CALL_COLOR, mDefaultColor);
            int callTimeOn = SlimSettings.System.getInt(resolver,
                    NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, mDefaultLedOn);
            int callTimeOff = SlimSettings.System.getInt(resolver,
        ...
        if (mVoicemailPref != null) {
            int vmailColor = SlimSettings.System.getInt(resolver,
                    NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, mDefaultColor);
            int vmailTimeOn = SlimSettings.System.getInt(resolver,
                    NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, mDefaultLedOn);
            int vmailTimeOff = SlimSettings.System.getInt(resolver,
        ...
        if (mApplicationPrefList != null) {
            ...
            for (Package pkg : mPackages.values()) {
                try {
                    ...
                    pref.setMultiColorLed(mMultiColorNotificationLed);
    ...
    private boolean parsePackageList() {
        final String baseString = SlimSettings.System.getString(getContentResolver(),
    ...
    private void savePackageList(boolean preferencesUpdated) {
        ...
        SlimSettings.System.putString(getContentResolver(),
                SlimSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES, value);
    }
    ...
    protected void updateValues(String packageName, Integer color, Integer timeon,
        ...
        if (packageName.equals(DEFAULT_PREF)) {
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, color);
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, timeon);
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, timeoff);
            refreshDefault();
            return;
        } else if (packageName.equals(MISSED_CALL_PREF)) {
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_CALL_COLOR, color);
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, timeon);
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, timeoff);
            refreshDefault();
            return;
        } else if (packageName.equals(VOICEMAIL_PREF)) {
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, color);
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, timeon);
            SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, timeoff);
            refreshDefault();
            return;
        }
    ...
    private void resetDefault() {
        ...
        mCustomEnabledPref.setChecked(false);
    ...
    protected void resetColors() {
        ...
        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, mDefaultColor);
        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_CALL_COLOR, mDefaultColor);
        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, mDefaultColor);

        // Reset to the framework default custom pulse length & speed
        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, mDefaultLedOn);
        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, mDefaultLedOff);

        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, mDefaultLedOn);
        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, mDefaultLedOff);

        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, mDefaultLedOn);
        SlimSettings.System.putInt(resolver, NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, mDefaultLedOff);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        mMenu.add(0, MENU_RESET, 0, org.slim.framework.internal.R.string.reset)
