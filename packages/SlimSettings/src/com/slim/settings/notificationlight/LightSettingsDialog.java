...
import com.slim.settings.notificationlight.ColorPickerView.OnColorChangedListener;
...
public class LightSettingsDialog extends AlertDialog implements
    ...
    protected LightSettingsDialog(Context context, int initialColor, int initialSpeedOn,
            int initialSpeedOff, boolean multiColorLed) {
        super(context);

        init(context, initialColor, initialSpeedOn, initialSpeedOff, multiColorLed, true);
    }
     ...
     */
    protected LightSettingsDialog(Context context, int initialColor, int initialSpeedOn,
            int initialSpeedOff, boolean multiColorLed, boolean onOffChangeable) {
        super(context);

        init(context, initialColor, initialSpeedOn,
                initialSpeedOff, multiColorLed, onOffChangeable);
    }

    private void init(Context context, int color, int speedOn, int speedOff,
            boolean multiColorLed, boolean onOffChangeable) {
        mNotificationManager =
                (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);

        mReadyForLed = false;
        mLedLastColor = 0;
        mMultiColor = multiColorLed;
    ...
    private void updateLed() {
        ...
        b.putBoolean("force_lights", true);
