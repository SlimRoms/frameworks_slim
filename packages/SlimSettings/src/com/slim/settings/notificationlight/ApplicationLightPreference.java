...
public class ApplicationLightPreference extends Preference implements
        DialogInterface.OnDismissListener, View.OnLongClickListener {
    ...
    private boolean mMultiColorLed = false;
    ...
    public ApplicationLightPreference(Context context, AttributeSet attrs) {
        ...
        mOnOffChangeable = context.getResources().getBoolean(
                org.slim.framework.internal.R.bool.config_ledCanPulse);
        init();
    }
     ...
     * @param offValue
     */
    public ApplicationLightPreference(Context context,
    ...
    public void setMultiColorLed(boolean multi) {
        mMultiColorLed = multi;
    }
    ...
    public Dialog getDialog() {
        final LightSettingsDialog d = new LightSettingsDialog(getContext(),
                0xFF000000 + mColorValue, mOnValue, mOffValue, mMultiColorLed, mOnOffChangeable); 
        ...
        d.setMultiColorLed(mMultiColorLed);
