 ...
 */
public class SlimNavigationBarFragment extends Fragment implements Callbacks {
    ...
    protected SlimNavigationBarView mNavigationBarView = null;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.slim_navigation_bar, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mNavigationBarView = (SlimNavigationBarView) view;
    ...
    public void setCurrentSysuiVisibility(int systemUiVisibility) {
        ...
        //TODO mNavigationBarMode = mStatusBar.computeBarMode(0, mSystemUiVisibility,
    ...
    private class MagnificationContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            SlimNavigationBarFragment.this.updateAccessibilityServicesState(mAccessibilityManager);
        }
    }
    ...
    public static View create(Context context, FragmentListener listener) {
        ...
        SlimNavigationBarFragment fragment = new SlimNavigationBarFragment();
