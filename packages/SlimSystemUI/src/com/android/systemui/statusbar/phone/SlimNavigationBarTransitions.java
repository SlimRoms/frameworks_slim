...
public final class SlimNavigationBarTransitions extends BarTransitions {

    private final SlimNavigationBarView mView;
    ...
    public SlimNavigationBarTransitions(SlimNavigationBarView view) {
    ...
    public void applyDarkIntensity(float darkIntensity) {
        mView.applyDarkIntensity(darkIntensity);
    }
