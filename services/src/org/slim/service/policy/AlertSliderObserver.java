...
public class AlertSliderObserver extends UEventObserver {
    ...
    private void init() {
        try {
            final String path = mContext.getResources().getString(R.string.alert_slider_state_path);
    ...
    private boolean isOrderInverted() {
        return false;// Settings.System.getIntForUser(
    ...
    private int getSilentMode() {
        int silentMode = 1;// Settings.System.getIntForUser(
