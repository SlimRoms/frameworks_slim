 ...
 */
package org.slim.service.policy;
...
import org.slim.framework.internal.policy.keyparser.KeysArray;
...
public class KeyHandler {
    ...
    public KeyHandler(Context context) {
        ...
        mKeysArray = KeyParser.getCategory(context, "screen_off_gestures").keys;
    }
    ...
    private String getScreenOffGesturePref(int scanCode) {
        Key key = mKeysArray.get(scanCode);
        String action = SlimSettings.System.getStringForUser(mContext.getContentResolver(),
                KeyParser.getPreferenceKey(scanCode), UserHandle.USER_CURRENT);
    ...
    private boolean isKeySupported(int scanCode) {
        return mKeysArray.get(scanCode) != null;
    }
