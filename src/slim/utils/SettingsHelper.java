...
public class SettingsHelper {
    ...
    public String getString(Uri settingsUri) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            return Settings.Secure.getString(resolver, settingsUri.getLastPathSegment());
        } else if (uri.startsWith(SETTINGS_SYSTEM)) {
            return Settings.System.getString(resolver, settingsUri.getLastPathSegment());
            ...
            return SlimSettings.Secure.getString(resolver, settingsUri.getLastPathSegment());
        } else if (uri.startsWith(SLIMSETTINGS_SYSTEM)) {
            return SlimSettings.System.getString(resolver, settingsUri.getLastPathSegment());
    ...
    public int getInt(Uri settingsUri, int def) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            return Settings.Secure.getInt(resolver, settingsUri.getLastPathSegment(), def);
        } else if (uri.startsWith(SETTINGS_SYSTEM)) {
            return Settings.System.getInt(resolver, settingsUri.getLastPathSegment(), def);
        } else if (uri.startsWith(SETTINGS_GLOBAL)) {
            return Settings.Global.getInt(resolver, settingsUri.getLastPathSegment(), def);
        } else if (uri.startsWith(SLIMSETTINGS_SECURE)) {
            return SlimSettings.Secure.getInt(resolver, settingsUri.getLastPathSegment(), def);
        } else if (uri.startsWith(SLIMSETTINGS_SYSTEM)) {
            return SlimSettings.System.getInt(resolver, settingsUri.getLastPathSegment(), def);
        } else if (uri.startsWith(SLIMSETTINGS_GLOBAL)) {
    ...
    public void putString(Uri settingsUri, String value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            Settings.Secure.putString(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SETTINGS_SYSTEM)) {
            Settings.System.putString(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SETTINGS_GLOBAL)) {
            Settings.Global.putString(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SLIMSETTINGS_SECURE)) {
            SlimSettings.Secure.putString(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SLIMSETTINGS_SYSTEM)) {
            SlimSettings.System.putString(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SLIMSETTINGS_GLOBAL)) {
    ...
    public void putInt(Uri settingsUri, int value) {
        ...
        if (uri.startsWith(SETTINGS_SECURE)) {
            Settings.Secure.putInt(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SETTINGS_SYSTEM)) {
            Settings.System.putInt(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SETTINGS_GLOBAL)) {
            Settings.Global.putInt(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SLIMSETTINGS_SECURE)) {
            SlimSettings.Secure.putInt(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SLIMSETTINGS_SYSTEM)) {
            SlimSettings.System.putInt(resolver, settingsUri.getLastPathSegment(), value);
        } else if (uri.startsWith(SLIMSETTINGS_GLOBAL)) {
